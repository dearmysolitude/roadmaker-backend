...
public class InProgressNode extends BaseTimeEntity {
    ...
    @ManyToOne
    @JoinColumn(name ="INPROGRESS_ROADMAP_ID")
    @JsonBackReference
    ...
    @Builder
    public InProgressNode(Roadmap roadmap, RoadmapNode roadmapNode, Member member,
                          Boolean done, InProgressRoadmap inProgressRoadmap,String blogKeyword) {
